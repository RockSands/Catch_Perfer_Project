package com.katch.perfer.kettle.core.db;
...
public class KettleDBClient {
	...
	private synchronized RowMetaAndData queryOneRow(String sql, int type, Object id) throws KettleException {
		...
		try {
			...
			parameterMeta.addValueMeta(new ValueMetaBase("id", type));
	...
	private synchronized void deleteTableRow(String sql, int type, Object id) throws KettleException {
		...
		try {
			PreparedStatement ps = database.prepareSQL(sql);
			RowMetaInterface parameterMeta = new RowMeta();
			parameterMeta.addValueMeta(new ValueMetaBase("id1", type));
	...
	public void insertRecord(KettleRecord record) throws KettleException {
		...
		table.addValue(new ValueMetaBase(KettleVariables.R_JOB_RECORD_UUID, ValueMetaInterface.TYPE_STRING),
				record.getUuid());
		table.addValue(new ValueMetaBase(KettleVariables.R_JOB_RECORD_ID_JOB, ValueMetaInterface.TYPE_STRING),
				record.getJobid());
		table.addValue(new ValueMetaBase(KettleVariables.R_JOB_RECORD_NAME_JOB, ValueMetaInterface.TYPE_STRING),
				record.getName());
		table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_ID_RUN, ValueMetaInterface.TYPE_STRING),
				record.getRunID());
		table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_STATUS, ValueMetaInterface.TYPE_STRING),
				record.getStatus());
		table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_HOSTNAME, ValueMetaInterface.TYPE_STRING),
				record.getHostname());
		table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_ERRORMSG, ValueMetaInterface.TYPE_STRING),
				record.getErrMsg());
		table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_CRON_EXPRESSION, ValueMetaInterface.TYPE_STRING),
				record.getCronExpression());
		table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_CREATETIME, ValueMetaInterface.TYPE_DATE),
				record.getCreateTime());
		table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_UPDATETIME, ValueMetaInterface.TYPE_DATE),
		...
		for (KettleRecordRelation relation : record.getRelations()) {
			...
			table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_DEPENDENT_MASTER_UUID_ID,
					ValueMetaInterface.TYPE_STRING), relation.getMasterUUID());
			table.addValue(
					new ValueMetaBase(KettleVariables.R_RECORD_DEPENDENT_META_ID, ValueMetaInterface.TYPE_STRING),
					relation.getMetaid());
			table.addValue(
					new ValueMetaBase(KettleVariables.R_RECORD_DEPENDENT_META_TYPE, ValueMetaInterface.TYPE_STRING),
					relation.getType());
			table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_CREATETIME, ValueMetaInterface.TYPE_DATE), now);
			allTables.add(table);
		}
	...
	private void insertHistory(KettleRecord record) throws KettleException {
		if (record.isFinished() || record.isError()) {
			...
			table.addValue(new ValueMetaBase(KettleVariables.R_JOB_RECORD_UUID, ValueMetaInterface.TYPE_STRING),
					record.getUuid());
			table.addValue(new ValueMetaBase(KettleVariables.R_HISTORY_RECORD_ID, ValueMetaInterface.TYPE_STRING),
					record.getJobid());
			table.addValue(new ValueMetaBase(KettleVariables.R_HISTORY_RECORD_NAME, ValueMetaInterface.TYPE_STRING),
					record.getName());
			table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_ID_RUN, ValueMetaInterface.TYPE_STRING),
					record.getRunID());
			table.addValue(new ValueMetaBase(KettleVariables.R_RECORD_STATUS, ValueMetaInterface.TYPE_STRING),
