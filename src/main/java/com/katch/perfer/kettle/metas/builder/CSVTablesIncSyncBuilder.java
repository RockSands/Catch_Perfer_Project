...
public class CSVTablesIncSyncBuilder {
	...
	DatabaseMeta targetDatabase = new DatabaseMeta(
		"192.168.80.138_kettle", "MySql", "Native",
	...
	targettii.setSQL("SELECT YH_ID,SP_ID,SCORE FROM SQY_RZDK_SPTJ");
	...
	toi.setTableName("SQY_RZDK_SPTJ");
