...
@Component("mahoutConsumerService")
@ConditionalOnProperty(name = "consumer.mahout.type", havingValue = "user")
public class MahoutConsumerUserService extends MahoutConsumerService {
    @Autowired
