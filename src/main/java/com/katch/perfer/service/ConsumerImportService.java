...
import com.katch.perfer.kettle.metas.builder.CSVTablesIncSyncBuilder;
 ...
 */
@Service
public class ConsumerImportService {
	...
	CSVTablesIncSyncBuilder cSVTablesIncSyncBuilder = new CSVTablesIncSyncBuilder();
